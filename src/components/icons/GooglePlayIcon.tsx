...
export const GooglePlayIcon: React.FC<GooglePlayIconProps> = ({
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="gradient1" x1="21.8" y1="33.29" x2="5.017" y2="16.508" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1 0 0 -1 0 42)">
        ...
        <linearGradient id="gradient2" x1="33.834" y1="21.999" x2="9.637" y2="21.999" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1 0 0 -1 0 42)">
          <stop offset="0" stopColor="#ffe000"/>
          <stop offset=".409" stopColor="#ffbd00"/>
          <stop offset=".775" stopColor="orange"/>
          <stop offset="1" stopColor="#ff9c00"/>
        </linearGradient>
        <linearGradient id="gradient3" x1="24.827" y1="19.704" x2="2.069" y2="-3.054" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1 0 0 -1 0 42)">
          <stop offset="0" stopColor="#ff3a44"/>
          <stop offset="1" stopColor="#c31162"/>
        </linearGradient>
        <linearGradient id="gradient4" x1="7.297" y1="41.824" x2="17.46" y2="31.661" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1 0 0 -1 0 42)">
      ...
      <path fill="url(#gradient1)" d="M10.4 7.5c-.3.3-.4.8-.4 1.4V31c0 .6.2 1.1.5 1.4l.1.1L23 20.1v-.2L10.4 7.5z"/>
      <path fill="url(#gradient2)" d="M27 24.3l-4.1-4.1V19.9l4.1-4.1.1.1 4.9 2.8c1.4.8 1.4 2.1 0 2.9l-5 2.7z"/>
      <path fill="url(#gradient3)" d="M27.1 24.2L22.9 20 10.4 32.5c.5.5 1.2.5 2.1.1l14.6-8.4"/>
      <path fill="url(#gradient4)" d="M27.1 15.8L12.5 7.5c-.9-.5-1.6-.4-2.1.1L22.9 20l4.2-4.2z"/>
